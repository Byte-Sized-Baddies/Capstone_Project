...
// Honeycomb SVG with liquid fill
            ...
            <div className="flex items-center justify-between mb-8 bg-[#fff6f9] rounded-xl p-4 border border-[#ffd6e8]">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="w-9 h-9 rounded-lg bg-white border border-[#ffd6e8] text-xl font-bold flex items-center justify-center hover:bg-[#ffd6e8] transition"
                >−</button>
                <div className="bg-[#ffd6e8] rounded-lg px-5 py-2 min-w-[90px] text-center font-bold text-sm">
                  {dailyGoal} tasks
                </div>
                <button
                  onClick={() => handleGoalChange(1)}
                ...
                <div key={i} className="flex flex-col items-center flex-1">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      background: d.isToday ? "#f9a8c9" : LIGHT_PINK,
